...
void createLabyrinth(){
 ...
 { 
   ...
   {
     //add up
     if(y1-32>0 && out.pixels[x1+(y1-32)*w]!= color(0,0,255) && ! exists(erased,x1,y1-32) )arbre.add(new Node(x1,y1-32,arbre.get(0)));
     
     //add right
     if(x1+32<h && out.pixels[x1+32+y1*w]!= color(0,0,255) &&! exists(erased,x1+32,y1) )arbre.add(new Node(x1+32,y1,arbre.get(0)));
     
     //add left
     if(x1-32>0 && out.pixels[x1-32+y1*w]!= color(0,0,255)&& ! exists(erased,x1-32,y1) )arbre.add(new Node(x1-32,y1,arbre.get(0)));
     
     //add down
     if(y1+32<h && out.pixels[x1+(y1+32)*w]!= color(0,0,255) &&! exists(erased,x1,y1+32) )arbre.add(new Node(x1,y1+32,arbre.get(0)));
     
     if(arbre.get(0).x !=x2 || arbre.get(0).y !=y2 ){
 ...
 void voirChemins(){
        ...
        // SI JE VEUX VOIR TOUT LE PARCOURS EN LARGEUR
